...
describe("Test Utils", async () => {
  ...
  it("getCommitTimeline should get the commit timeline", async () => {
    ...
    var route = {
      ...
      addresses: {
        hashId: { hashId: "hashId", line1: "line1", line2: "line2", recipient: "recipient", publicKey: "publicKey" }
      },
      couriers: {
        hashId: { hashId: "hashId", name: "name", company: "company", telephone: "telephone", publicKey: "publicKey" }
      },
      source: {
        address: "hashId",
        expectedArrivalTimestamp: 0,
